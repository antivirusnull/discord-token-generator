...
setTitle('CREATED | TOKEN GENERATOR | NULL | 360');
const fs = require('fs');
...
\x1B[34m[ \x1b[37m3 \x1B[34m] \x1b[37mEXIT
  ...
  if(choice == 1){
    ...
    console.clear();
    setTitle(`CREATED | TOKEN GENERATOR | @NULL | 360 ( Success ${success}/${HowTokens} | Failed ${failed} )`);
    if(random_name == 'n'){
      ...
      for (let i = 0; i < HowTokens; i++) {
        ...
        try {
          ...
          if(webhook_use == 'y'){
            ...
            hook.setUsername("CREATED | TOKEN GENERATOR | NULL | 360")
